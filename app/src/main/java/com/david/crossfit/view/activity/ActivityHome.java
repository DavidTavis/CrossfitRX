...
import com.david.crossfit.view.fragment.FragmentChannelVideo;
import com.david.crossfit.view.fragment.FragmentVideo;
...
public final class ActivityHome extends AppCompatActivity implements YouTubePlayer.OnFullscreenListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AccountHeader accountHeader = new AccountHeaderBuilder()
                .withActivity(this)
                .withHeaderBackground(R.drawable.header2_1)
                .build();
        ...
        drawer = new DrawerBuilder(this)
                ...
                .addStickyDrawerItems(
                        new SecondaryDrawerItem()
                                .withName(getString(R.string.tools))
