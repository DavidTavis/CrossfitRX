package com.david.crossfit.view.util;
...
public class Utils {
    ...
    public static final int ARG_TRIGGER_VALUE = 13;
    ...
    public static String formatPublishedDate(Context activity, String publishedDate){
